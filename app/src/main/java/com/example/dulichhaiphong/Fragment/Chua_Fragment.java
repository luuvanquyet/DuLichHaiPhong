...
public class Chua_Fragment extends Fragment  {
    ...
    private View view;
    private ImageView imgDammayLeft,back;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(CheckConNection.haveNetwordConnection(view.getContext())){
            ...
            HienLRecyclerView();
            Hieuungmay();
            Read_anhSlider(url_read_Slider,arraySlider,"app-chua");
            HienSilder();
        }else{
    ...
    private void Anhxa(){
        ...
        imgHeader.setImageResource(R.drawable.anh_phat_header);
    ...
    private void HienLRecyclerView(){
        ...
        Timkiem_baiviet(Server.url_read_danhsach_baiviet,DanhsachBaiViet,"Chùa",tenCap,tenLoaiditich,tenQuanHuyen);
