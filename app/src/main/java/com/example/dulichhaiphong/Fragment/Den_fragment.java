...
public class Den_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(CheckConNection.haveNetwordConnection(view.getContext())){
            ...
            HienLRecyclerView();
            Hieuungmay();
            Read_anhSlider(url_read_Slider,arraySlider,"app-den");
            HienSilder();
        }else{
    ...
    private void Anhxa(){
        ...
        imgHeader.setImageResource(R.drawable.backgroud_den);
    ...
    private void HienLRecyclerView(){
        ...
        Timkiem_baiviet(Server.url_read_danhsach_baiviet,DanhsachBaiViet,"Đền",tenCap,tenLoaiditich,tenQuanHuyen);
