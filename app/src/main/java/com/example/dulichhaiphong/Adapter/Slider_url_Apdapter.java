...
public class Slider_url_Apdapter extends RecyclerView.Adapter<Slider_url_Apdapter.SliderViewHolder> {
    private ArrayList<Anh_Slider_URL> sliderItemList;
    private ViewPager2 viewPager2;
    private String url_anh ="http://dulichhaiphong.xyz/images/sliders/";

    public Slider_url_Apdapter(ArrayList<Anh_Slider_URL> sliderItemList) {
        this.sliderItemList = sliderItemList;
    }

    public Slider_url_Apdapter(ArrayList<Anh_Slider_URL> sliderItemList, ViewPager2 viewPager2) {
        this.sliderItemList = sliderItemList;
    ...
    @Override
    public Slider_url_Apdapter.SliderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Slider_url_Apdapter.SliderViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_item_baiviet,parent,false)
        );
    }

    @Override
    public void onBindViewHolder(@NonNull Slider_url_Apdapter.SliderViewHolder holder, final int position) {
